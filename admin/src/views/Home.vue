      ...
      <el-menu router :default-openeds="['1']">
        <el-submenu index="1">
          ...
          <el-menu-item-group>
            ...
            <el-menu-item index="1-1">新建物品</el-menu-item>
            <el-menu-item index="1-2">物品列表</el-menu-item>
          </el-menu-item-group>
          <el-menu-item-group>
        ...
        <el-submenu index="3">
          ...
          <el-menu-item-group>
            ...
            <el-menu-item index="3-2">分类列表</el-menu-item>
          </el-menu-item-group>
          <el-menu-item-group>
            <template slot="title">管理员</template>
            <el-menu-item index="3-1">新建管理员</el-menu-item>
